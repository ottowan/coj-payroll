...
const Index = () => {
  ...
  const [title, setTitle] = useState(titleInit("สำหรับพิมพ์สลิปเงินเดือน ", "รายบุคคล", "ข้าราชการตุลาการ"))
